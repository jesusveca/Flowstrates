...
//  private static final boolean SHOW_TIME_CAPTION = true;
  ...
  public FlowstratesView(FlowMapGraph fmg, GeoMap areaMap, MapProjection proj, ViewConfig config) {
    ...
    logger.info("Abriendo flowstrates view");
...
//    temporalLayer = new HeatmapLayer(this);
    ...
    addCaption(originMapLayer.getCamera(),
        viewConfig.getStringOrElse(VIEW_CONFIG_PROP_MSG_ORIGINS_CAPTION, "Origenes"));
...
//    }
    ...
    addCaption(destMapLayer.getCamera(),
        viewConfig.getStringOrElse(VIEW_CONFIG_PROP_MSG_DESTS_CAPTION, "Destinos"));
...
//    buttonPanel.addChild(explainButton);
    ...
    final PButton linesButton = new PButton("LINEAS", true);
    ...
    final PButton groupByOriginButton = new PButton("POR ORIGEN", true);
    final PButton groupByDestButton = new PButton(" POR DEST ", true);
    final PButton allToAllButton = new PButton("AGRUPAR TODO", true);
    ...
    final PButton sortByMaxButton = new PButton("SORT POR MAX", false);
    ...
    final PButton sortByAvgButton = new PButton("SORT POR PROM", false);
    ...
    PButton originsClearButton = new PButton("LIMPIAR");
    ...
    PButton originsFitButton = new PButton("ENCAJAR");
    ...
    PButton destClearButton = new PButton("LIMPIAR");
    ...
    PButton destFitButton = new PButton("ENCAJAR");
    ...
    PButton tempFitButton = new PButton("ENCAJAR");
    ...
    PButton tempFitAllButton = new PButton("TODO");
